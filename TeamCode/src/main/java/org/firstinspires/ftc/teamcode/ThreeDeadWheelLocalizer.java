...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 10189.53667712065; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -9916.727025967837; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -9200.256518623017; // x position of the perpendicular encoder (in tick units)
    }
