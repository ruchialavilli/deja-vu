...
@Autonomous(name="LeftBlueNew", group="AutoOpModes")
public class LeftBlueNew extends BaseAutoVisionOpMode {
//This code contains the basic chassis movements for the Right Red Auton Position
        private String TAG = "LeftBlueNew";
        private ElapsedTime runtime = new ElapsedTime();
        String name = "LeftBlueNew";
